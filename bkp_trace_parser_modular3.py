...
class Trace():
    ...
    def analyze(self):
        ...
        return self.WriteOutputlog_ads(mode='lib'), self.start_time, self.cpu
...
def main():
    ...
    _trace_file = '/Users/jnejati/PycharmProjects/wpt/traces/2_testbed01_ads.trace'
    ...
    """for t in trace.networks_list:
        if 'dcmads.js' in t[1]['url']:
            ...
            print(t)
    exit()"""
    _output_file = './results/1_testbed01_noads.json'
    trace.WriteJson(_output_file, _result)
    trace.draw_waterfall(_output_file, '1_testbed01_noads.html')
