...
def main():
        ...
        for _site_dir in _sites:
            ...
            for _run_no in _runs:
                ...
                if len(_pfile) == 1 and len(_afile) == 1:
                    ...
                    print(_site_dir, _run_no)
                    _ttfb = read_ttfb_time(_analysis_file)
                    _load_value.append(_load)
                    _ttfb_value.append(_ttfb)
                    if _ttfb:
    ...
    with open('/home/jnejati/PLTSpeed/collectors/ttfb_cor_result_50.txt', 'w+') as _outf:
