...
tc class add dev enp1s0f0 parent 1:1 classid 1:11 htb rate 5Mbit
tc qdisc add dev enp1s0f0  parent 1:11 handle 10: netem delay 50ms
...
#tc filter add dev enp1s0f0  parent 1: protocol ip prio 1 u32 match ip dport 9222 0xffff match ip sport 9222 0xffff flowid 1:12
